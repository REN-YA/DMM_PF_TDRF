...
def notification_form(notification)
    ...
    when "review" then
      ...
      tag.a(@visiter.name, href:user_user_path(@visiter), style:"font-weight: bold;")+"が"+tag.a(@review.product.name, href:store_store_product_path(notification.store_id, notification.product_id), style:"font-weight: bold;")+"にレビューしました"
    end
end
