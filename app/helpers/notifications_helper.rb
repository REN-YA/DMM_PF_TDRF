...
def notification_form(notification)
    ...
    when "review" then
      ...
      tag.a(@visiter.name, href:user_user_path(@visiter), style:"font-weight: bold;")+"が"+tag.a(@review.product.name, href:store_store_product_path(notification.product_id, current_store.id), style:"font-weight: bold;")+"にレビューしました"
    end
end
